...
function MainEditor({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <ContainerWithBorder
      ...
      className="mx-auto rounded-md overflow-hidden grid grid-rows-[min-content_1fr_min-content] flex-grow w-full grid-cols-[57px_max-content_1fr_min-content] editor-grid"
    >
