    ...
    return (
        <motion.div initial="hide" animate="show" className="grid gap-8 p-3 lg:p-6 lg:grid-cols-2 grow xl:gap-20" variants={containerVariants}>
            ...
            <div className="relative flex justify-center lg:justify-start">
                <svg width="864" height="784" viewBox="0 0 864 784" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 w-full h-full">
                    ...
                    <defs>
                        <filter id="filter0_f_64_1236" x="0" y="0.827728" width="863.983" height="782.77" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                ...
                <svg width="868" height="831" viewBox="0 0 868 831" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 w-full h-full">
                    ...
                    <defs>
                        <filter id="filter0_f_64_1235" x="0.663574" y="0.391769" width="880.938" height="830.128" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
