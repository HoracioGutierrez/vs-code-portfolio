...
async function TrabajosPage({ searchParams }: TrabajosPageProps) {
    ...
    return (
        <motion.div initial="hide" animate="show" exit="exit" className="flex flex-col justify-center items-center p-8 w-full h-full grow" variants={{ show: { transition: { staggerChildren: 0.3, delay : 5 } }, exit: { transition: { staggerChildren: 0.3 } } }}>
